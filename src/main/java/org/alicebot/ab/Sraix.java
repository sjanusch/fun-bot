...
public class Sraix {
  ...
  private static final org.slf4j.Logger logger = LoggerFactory.getLogger(Sraix.class);
  ...
  public static String sraixPannous(String input, String hint, Chat chatSession) {
    try {
      ...
      logger.trace("in Sraix.sraixPannous, url: '" + url + "'");
      ...
      if (page == null || page.length() == 0) {
        ...
        if (outputJson.length() == 0) {
          ...
          if (actions.has("reminder")) {
            ...
            logger.trace("in Sraix.sraixPannous, found say action");
          ...
          if (actions.has("show") && !text.contains("Wolfram")
            ...
            logger.trace("in Sraix.sraixPannous, found show action");
